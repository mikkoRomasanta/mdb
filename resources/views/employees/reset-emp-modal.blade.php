            ...
            <div class="modal-body">
                {{Form::open(['action' => 'EmployeeController@resetPass', 'method' => 'POST'])}}
                    ...
                    <div class="form-group row" id="emailDiv">
                        ...
                        {{Form::text('email','',['id' => 'emailBox', 'class' => 'col-md-6 form-control', 'readonly'])}}
                    </div>
                   <div class="form-group row" id="passDiv">
                        {{Form::label('reset_pass_base','Temporary Password:',['class' => 'col-md-3 col-form-label', 'style' => 'font-weight: bold'])}}
                        {{Form::text('reset_pass_base','pass',['id' => 'passBaseBox', 'class' => 'col-md-1 form-control', 'readonly'])}}
                        <span class='pt-2' style="backgound-color:red"><i class='fas fa-plus fa-fw'></i></span>
                        {{Form::text('reset_pass_suffix','',['id' => 'passSuffixBox', 'class' => 'col-md-1 form-control', 'readonly'])}}
                   </div>
